...
namespace MyToDo.Api
{
    ...
    /// </summary>
    public static class UOW_UnitOfWorkServiceCollectionExtensions
    {
        /// <summary>
        ...
        {
            services.AddScoped<UOW_IRepositoryFactory, UOW_UnitOfWork<TContext>>();
            ...
            services.AddScoped<UOW_IUnitOfWork, UOW_UnitOfWork<TContext>>();
            services.AddScoped<IUnitOfWork<TContext>, UOW_UnitOfWork<TContext>>();
        ...
        {
            services.AddScoped<IUnitOfWork<TContext1>, UOW_UnitOfWork<TContext1>>();
            services.AddScoped<IUnitOfWork<TContext2>, UOW_UnitOfWork<TContext2>>();
            ...
            where TContext3 : DbContext
        {
            services.AddScoped<IUnitOfWork<TContext1>, UOW_UnitOfWork<TContext1>>();
            services.AddScoped<IUnitOfWork<TContext2>, UOW_UnitOfWork<TContext2>>();
            services.AddScoped<IUnitOfWork<TContext3>, UOW_UnitOfWork<TContext3>>();
            ...
            where TContext4 : DbContext
        {
            ...
            services.AddScoped<IUnitOfWork<TContext2>, UOW_UnitOfWork<TContext2>>();
            services.AddScoped<IUnitOfWork<TContext3>, UOW_UnitOfWork<TContext3>>();
            services.AddScoped<IUnitOfWork<TContext4>, UOW_UnitOfWork<TContext4>>();
        ...
        public static IServiceCollection AddCustomRepository<TEntity, TRepository>(this IServiceCollection services)
            where TEntity : class
            where TRepository : class, UOW_IRepository<TEntity>
        {
            services.AddScoped<UOW_IRepository<TEntity>, TRepository>();

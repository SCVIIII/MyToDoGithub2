...
{
    public class MT1_AddMemoViewModel : BindableBase,MT1_IDialogHostAware
    {
        public MT1_AddMemoViewModel()
        {
        ...
        private MT3_MemoDto model;
        /// <summary>
        /// 新增或编辑的实体
        /// </summary>
        public MT3_MemoDto Model
        {
            get { return model; }
        ...
        public void OnDialogOpen(IDialogParameters parameters)
        {
            ...
            {
                Model = parameters.GetValue<MT3_MemoDto>("Value");
            }
            else
                Model = new MT3_MemoDto();
        }
    }
}
